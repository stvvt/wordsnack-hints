...
/* WEBPACK VAR INJECTION */(function(global) {__webpack_require__(325);

var candidates = __webpack_require__(327);

var chunk = __webpack_require__(331);
...
function filterRealWords(candidates, cb) {
  ...
  try {
    for (var _iterator = chunk(candidates, maxWordsInQuery)[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
      var _g = _step.value;

      var search = _g.join('|');

      var url = "https://bg.wiktionary.org/w/api.php?origin=*&format=json&action=query&titles=" + encodeURIComponent(search);
      var fetchOptions = {
        mode: 'cors',
        // credentials: 'include',
        method: 'GET',
      ...
      fetch(url, fetchOptions).then(function (response) {
        ...
        Object.keys(obj).filter(function (key) {
          return typeof obj[key].missing === 'undefined';
...
var _marked =
/*#__PURE__*/
regeneratorRuntime.mark(candates);

var permutations = __webpack_require__(328);

var combinations = __webpack_require__(329);

var eligible = __webpack_require__(330);

function candates(letters, wordlength) {
  var _iteratorNormalCompletion, _didIteratorError, _iteratorError, _iterator, _step, _c, _iteratorNormalCompletion2, _didIteratorError2, _iteratorError2, _iterator2, _step2, _p;

  return regeneratorRuntime.wrap(function candates$(_context) {
    while (1) {
      switch (_context.prev = _context.next) {
        case 0:
          ...
          _context.prev = 3;
          _iterator = combinations(letters.split(''), wordlength)[Symbol.iterator]();
        ...
        case 5:
          ...
          _context.prev = 10;
          _iterator2 = permutations(_c)[Symbol.iterator]();
...
module.exports =
/*#__PURE__*/
regeneratorRuntime.mark(function permutations(arr) {
  var _iteratorNormalCompletion, _didIteratorError, _iteratorError, _iterator, _step, _p, i, q;
    ...
    while (1) {
      switch (_context.prev = _context.next) {
        ...
        case 4:
          ...
          _iteratorError = undefined;
          _context.prev = 7;
          _iterator = permutations(arr.slice(1))[Symbol.iterator]();
  ...
  }, permutations, this, [[7, 25, 29, 37], [30,, 32, 36]]);
});
...
var _marked =
/*#__PURE__*/
regeneratorRuntime.mark(combinations);

function combinations(arr, n) {
  var _iteratorNormalCompletion, _didIteratorError, _iteratorError, _iterator, _step, _c;
  ...
  return regeneratorRuntime.wrap(function combinations$(_context) {
    while (1) {
      switch (_context.prev = _context.next) {
        ...
        case 8:
          return _context.delegateYield(combinations(arr.slice(1), n), "t0", 9);
        ...
        case 9:
          ...
          _iteratorError = undefined;
          _context.prev = 12;
          _iterator = combinations(arr.slice(1), n - 1)[Symbol.iterator]();
  ...
  }, _marked, this, [[12, 23, 27, 35], [28,, 30, 34]]);
}
...
function chunk(generator, size) {
  var groupItems, _iteratorNormalCompletion, _didIteratorError, _iteratorError, _iterator, _step, _i;

  return regeneratorRuntime.wrap(function chunk$(_context) {
    while (1) {
      switch (_context.prev = _context.next) {
        case 0:
          groupItems = [];
          ...
          _iteratorError = undefined;
          _context.prev = 4;
          _iterator = generator[Symbol.iterator]();
  ...
  }, _marked, this, [[4, 18, 22, 30], [23,, 25, 29]]);
}
